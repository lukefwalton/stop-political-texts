...
Open source:
Stop Political Spam Texts is open source under the MIT License so anyone can inspect how it works.
...
TODO: a public page with real contact information. Options: the repository
Issues page once the repo is public, or a simple support/contact page. Apple
requires working contact info here.
